...
<p class="question">Rank your 5 favorite, and least favorite, activities from this <a href="https://gist.github.com/fool/b0f254ff8c72a5765b6a9138249789d6">list</a>:
...
<p>The biggest challenge was setting up the redirect. Luckily, it was fast to find the documentation located <a href="https://www.netlify.com/docs/redirects/">here</a>. I must admit I was unsure if I needed to put it in a special folder or add an extension to the file as <code>_redirects</code> looked similar to the convention for folders e.g. _includes or _layouts that Jekyll uses.

<p class="question">Could you give us a suggestion to improve this test or the job posting?</p>
<p>It would be helpful to have an overview or a link to a blog post in the job listing explaining a "day in the life as a <u>support engineer</u>." I know for many jobs and likely this one as well, the workday can vary greatly, but it might be nice to see what a typical schedule would look like. 
